...
This function receives the value read by the ultrasonic sensor, and in order to obtain the distance between an object and the sensor in inches, divides by 2.54 the return of the distance_cm function.
 ...
 Get the values and display them on the OLED display
  ```c
...
#### Example
Check if an object is within a interval
```c
underLimit = 10;
upperLimit = 15;
sprintf(msg1, "itsBetween");
sprintf(msg2, "[%2.0f , %2.0f]", underLimit, upperLimit);
if(itsBetween(&hcsr04,underLimit, upperLimit)){
	sprintf(msg3, "YES");
}else{
	sprintf(msg3, "NOT");
}
```
<br/>
<div align="center"><img src="https://user-images.githubusercontent.com/38631264/108757985-524fc300-7529-11eb-8f18-65e57765341e.jpeg" width=600></div>
<br/>
